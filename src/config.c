...
static const char* default_theme_toml =
    "[content]\n"
    "line-number = { fg = \"#858585\", bg = \"#1E1E1E\" }\n"
    "line-number-active = { fg = \"#C8C8C8\", bg = \"#2A2A2A\" }\n"
    "line-number-sticky = { fg = \"#858585\", bg = \"#181818\" }\n"
    "cursor-line = { bg = \"#2A2A2A\" }\n"
    "selection = { bg = \"#4A4A4A\" }\n"
    ...
    "\n"
    "[statusline]\n"
    "mode-insert = { fg = \"#1E1E1E\", bg = \"#A8CC8C\", bold = true }\n"
    "mode-normal = { fg = \"#1E1E1E\", bg = \"#8AB8F3\", bold = true }\n"
    "mode-visual = { fg = \"#1E1E1E\", bg = \"#D29FF1\", bold = true }\n"
    "mode-command = { fg = \"#1E1E1E\", bg = \"#F9C74F\", bold = true }\n"
    "text = { fg = \"#D4D4D4\", bg = \"#252526\" }\n"
    "\n"
    "[syntax]\n"
    "keyword = { fg = \"#C586C0\" }\n"
    "keyword-storage-type = { fg = \"#C586C0\" }\n"
    "keyword-storage-modifier = { fg = \"#C586C0\" }\n"
    "keyword-control = { fg = \"#C586C0\" }\n"
    "keyword-control-repeat = { fg = \"#C586C0\" }\n"
    "keyword-control-return = { fg = \"#C586C0\" }\n"
    "keyword-control-conditional = { fg = \"#C586C0\" }\n"
    "keyword-directive = { fg = \"#C586C0\" }\n"
    "function-special = { fg = \"#DCDCAA\" }\n"
    "string = { fg = \"#6A9955\" }\n"
    "constant-character = { fg = \"#4EC9B0\" }\n"
    "type-enum-variant = { fg = \"#4EC9B0\" }\n"
    "constant-character-escape = { fg = \"#D7BA7D\" }\n"
    "constant-numeric = { fg = \"#B5CEA8\" }\n"
    "constant-builtin-boolean = { fg = \"#B5CEA8\" }\n"
    "constant = { fg = \"#B5CEA8\" }\n"
    "variable = { fg = \"#E0E0E0\" }\n"
    "variable-parameter = { fg = \"#9CDCFE\", italic = true }\n"
    "variable-other-member = { fg = \"#4EC9B0\" }\n"
    "function = { fg = \"#DCDCAA\" }\n"
    "type = { fg = \"#4EC9B0\" }\n"
    ...
    "[picker]\n"
    "item-text = { fg = \"#D4D4D4\" }\n"
    "item-text-highlight = { fg = \"#8AB8F3\", bold = true }\n"
    "\n"
    "[popup.border]\n"
    "fg = \"#8AB8F3\"\n"
    "\n"
...
static const char* onedarker_theme_toml =
    "[content]\n"
    "line-number = { fg = \"#495162\", bg = \"#21252b\" }\n"
    "line-number-active = { fg = \"#abb2bf\", bg = \"#282c34\" }\n"
    "line-number-sticky = { fg = \"#495162\", bg = \"#1c1f24\" }\n"
    "cursor-line = { bg = \"#282c34\" }\n"
    "selection = { bg = \"#3e4452\" }\n"
    ...
    "\n"
    "[statusline]\n"
    "mode-insert = { fg = \"#21252b\", bg = \"#98c379\", bold = true }\n"
    "mode-normal = { fg = \"#21252b\", bg = \"#61afef\", bold = true }\n"
    "mode-visual = { fg = \"#21252b\", bg = \"#c678dd\", bold = true }\n"
    "mode-command = { fg = \"#21252b\", bg = \"#e5c07b\", bold = true }\n"
    "text = { fg = \"#abb2bf\", bg = \"#1c1f24\" }\n"
    "\n"
    "[syntax]\n"
    "keyword = { fg = \"#c678dd\" }\n"
    "keyword-storage-type = { fg = \"#c678dd\" }\n"
...
static const char* solarized_dark_toml =
    "[content]\n"
    "line-number = { fg = \"#586e75\", bg = \"#002b36\" }\n"
    "line-number-active = { fg = \"#839496\", bg = \"#073642\" }\n"
    "line-number-sticky = { fg = \"#586e75\", bg = \"#002b36\" }\n"
    "cursor-line = { bg = \"#073642\" }\n"
    "selection = { bg = \"#073642\" }\n"
    "background = { bg = \"#002b36\" }\n"
    "whitespace = { fg = \"#586e75\" }\n"
    "\n"
    "[search]\n"
    "match = { bg = \"#586e75\" }\n"
    "\n"
    "[statusline]\n"
    "mode-insert = { fg = \"#eee8d5\", bg = \"#859900\", bold = true }\n"
    "mode-normal = { fg = \"#eee8d5\", bg = \"#268bd2\", bold = true }\n"
    "mode-visual = { fg = \"#eee8d5\", bg = \"#d33682\", bold = true }\n"
    "mode-command = { fg = \"#eee8d5\", bg = \"#cb4b16\", bold = true }\n"
    "text = { fg = \"#93a1a1\", bg = \"#073642\" }\n"
    "\n"
    "[syntax]\n"
    "keyword = { fg = \"#859900\" }\n"
    "keyword-storage-type = { fg = \"#859900\" }\n"
    "keyword-storage-modifier = { fg = \"#859900\" }\n"
    "keyword-control = { fg = \"#859900\" }\n"
    "keyword-control-repeat = { fg = \"#859900\" }\n"
    "keyword-control-return = { fg = \"#859900\" }\n"
    "keyword-control-conditional = { fg = \"#859900\" }\n"
    "keyword-directive = { fg = \"#cb4b16\" }\n"
    "function-special = { fg = \"#268bd2\" }\n"
    "string = { fg = \"#2aa198\" }\n"
    "constant-character = { fg = \"#2aa198\" }\n"
    "type-enum-variant = { fg = \"#2aa198\" }\n"
    "constant-character-escape = { fg = \"#cb4b16\" }\n"
    "constant-numeric = { fg = \"#cb4b16\" }\n"
    "constant-builtin-boolean = { fg = \"#cb4b16\" }\n"
    "constant = { fg = \"#2aa198\" }\n"
    "variable = { fg = \"#268bd2\" }\n"
    "variable-parameter = { fg = \"#268bd2\", italic = true }\n"
    "variable-other-member = { fg = \"#268bd2\" }\n"
    "function = { fg = \"#268bd2\" }\n"
    "type = { fg = \"#b58900\" }\n"
    ...
    "[picker]\n"
    "item-text = { fg = \"#839496\" }\n"
    "item-text-highlight = { fg = \"#268bd2\", bold = true }\n"
    "\n"
    "[popup.border]\n"
    "fg = \"#268bd2\"\n"
    "\n"
...
static const char* solarized_light_toml =
    "[content]\n"
    "line-number = { fg = \"#93a1a1\", bg = \"#fdf6e3\" }\n"
    "line-number-active = { fg = \"#657b83\", bg = \"#eee8d5\" }\n"
    "line-number-sticky = { fg = \"#93a1a1\", bg = \"#fdf6e3\" }\n"
    "cursor-line = { bg = \"#eee8d5\" }\n"
    "selection = { bg = \"#eee8d5\" }\n"
    "background = { bg = \"#fdf6e3\" }\n"
    "whitespace = { fg = \"#93a1a1\" }\n"
    "\n"
    "[search]\n"
    "match = { bg = \"#93a1a1\" }\n"
    "\n"
    "[statusline]\n"
    "mode-insert = { fg = \"#fdf6e3\", bg = \"#859900\", bold = true }\n"
    "mode-normal = { fg = \"#fdf6e3\", bg = \"#268bd2\", bold = true }\n"
    "mode-visual = { fg = \"#fdf6e3\", bg = \"#d33682\", bold = true }\n"
    "mode-command = { fg = \"#fdf6e3\", bg = \"#cb4b16\", bold = true }\n"
    "text = { fg = \"#586e75\", bg = \"#eee8d5\" }\n"
    "\n"
    "[syntax]\n"
    "keyword = { fg = \"#859900\" }\n"
    "keyword-storage-type = { fg = \"#859900\" }\n"
...
void config_load_theme(char *name, Theme *theme) {
    ...
    } else if (strcmp(name, "solarized_dark") == 0) {
        toml_content = solarized_dark_toml;
    } else if (strcmp(name, "solarized_light") == 0) {
        toml_content = solarized_light_toml;
    }
